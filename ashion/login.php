...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <ul class="offcanvas__widget">
            ...
            <li><a href="wisjlist.php"><span class="icon_bag_alt"></span>
                    ...
                    <div class="login-form">
                        ...
                        <form onsubmit="return false;">
                            <div class="group-input">
                                <label for="username" placeholder="enter your email id">email address *</label>
                            ...
                            <button type="submit" class="site-btn login-btn" style="background:black;" onclick="login();">Sign In</button>
                        </form>
